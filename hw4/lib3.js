...
// THIS IS THE SHAPE OF THE TRIANGLE MESH THAT WILL BE RENDERED.
...
function gl_start(canvas, vertexShader, fragmentShader) {           // START WEBGL RUNNING IN A CANVAS
   ...
   setTimeout(function() {
	 ...
	 gl.program = program;
         ...
         gl.bufferData(gl.ARRAY_BUFFER, new Float32Array(vertices), gl.STATIC_DRAW); //    consisting of two triangles.
      ...
      setInterval(function() {                                             // Start the animation loop.
         ...
         animate(gl);
         gl.drawArrays(gl.TRIANGLE_STRIP, 0, vertices.length/3);                                    // Render the square.
